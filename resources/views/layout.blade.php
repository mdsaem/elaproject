...
<div class="header-bottom"><!--header-bottom-->
    ...
    <div class="col-sm-3">
        <div class="left-sidebar">
            ...
            <?php
                 $manufacturer_by_product=DB::table('manufacturers')
                 ->where('publication_status',1)
                 ->get();


         foreach ($manufacturer_by_product as $manufacturer) {?>
        <li><a href="{{URL::to('/product_by_manufacturer/'.$manufacturer->manufacturer_id)}}"> <span class="pull-right">(50)</span>{{$manufacturer->manufacturer_name}}</a></li>
