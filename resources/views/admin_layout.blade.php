...
<a class="brand" href="{{URL::to('/dashboard')}}"><span>Admin Home</span></a>
...
<div class="row-fluid">
	...
	<ul class="nav nav-tabs nav-stacked main-menu">
		...
		<li>
		<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Admin</span><span class="label label-important"> New </span></a>
		<ul>
			<li><a class="submenu" href="{{URL::to('/all-admin')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Admin</span></a></li>
			<li><a class="submenu" href="{{URL::to('/add-admin')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Admin</span></a></li>
		...
		<li><a href="{{URL::to('/all-manufacturer')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Manufacturer</span></a></li>
		<li><a href="{{URL::to('/add-manufacturer')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Manufacturer</span></a></li>
		<li>
...
<p>
	<span style="text-align:left;float:left">&copy; 2018 <a href="http://bootstrapmaster.com/" alt="Bootstrap Themes">eng.saemhosain@gmail.com</a></span>
	<span class="hidden-phone" style="text-align:right;float:right">Powered by: <a href="http://admintemplates.co/" alt="Bootstrap Admin Templates" > Portfolio  </a></span>
</p>
